    ...
    <el-row :gutter="20">
      ...
      <el-col :span="4" :xs="24">
        <div class="head-container">
          <el-input v-model="categoryName" placeholder="请输入物料分类名" clearable size="small"
                    prefix-icon="el-icon-search"
                    style="margin-bottom: 20px"
          />
        </div>
        <el-button icon="el-icon-refresh" @click="resetNodeClick" size="small">重置</el-button>
      ...
      <el-col :span="20" :xs="24">
        ...
        >
          ...
          <el-form-item label="物料分类ID" prop="categoryId">
            <el-input v-model="queryParams.categoryId" placeholder="请输入物料分类ID" clearable
                      @keyup.enter.native="handleQuery"
            />
          </el-form-item>
          <el-form-item label="物料分类代码" prop="categoryCode">
            <el-input v-model="queryParams.categoryCode" placeholder="请输入物料分类代码" clearable
                      @keyup.enter.native="handleQuery"
            />
          </el-form-item>
  ...
  methods: {
    ...
    getTreeSelect() {
      listSimpleCategories().then(response => {
        // 处理 categoryOptions 参数
        this.categoryOptions = []
        console.log(response.data)
        this.categoryOptions.push(...this.handleTree(response.data, 'id'))
      })
    },
    /** 重置分类 */
    resetNodeClick() {
