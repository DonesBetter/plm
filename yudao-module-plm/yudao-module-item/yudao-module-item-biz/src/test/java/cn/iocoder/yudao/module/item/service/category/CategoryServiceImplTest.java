...
import cn.iocoder.yudao.module.item.controller.admin.category.vo.CategoryCreateReqVO;
import cn.iocoder.yudao.module.item.controller.admin.category.vo.CategoryExportReqVO;
import cn.iocoder.yudao.module.item.controller.admin.category.vo.CategoryPageReqVO;
import cn.iocoder.yudao.module.item.controller.admin.category.vo.CategoryUpdateReqVO;
...
import static cn.iocoder.yudao.module.item.enums.ErrorCodeConstants.CATEGORY_NOT_FOUND;
...
public class CategoryServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateCategory_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> categoryService.updateCategory(reqVO), CATEGORY_NOT_FOUND);
    }
    ...
    public void testDeleteCategory_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> categoryService.deleteCategory(id), CATEGORY_NOT_FOUND);
    }
    ...
    public void testGetCategoryPage() {
       ...
       // 测试 parentCode 不匹配
       categoryMapper.insert(cloneIgnoreId(dbCategory, o -> o.setParentCode(null)));
       // 测试 categoryCode 不匹配
       categoryMapper.insert(cloneIgnoreId(dbCategory, o -> o.setCategoryCode(null)));
       // 测试 name 不匹配
       ...
       // 测试 picUrl 不匹配
       categoryMapper.insert(cloneIgnoreId(dbCategory, o -> o.setPicUrl(null)));
       // 测试 sort 不匹配
